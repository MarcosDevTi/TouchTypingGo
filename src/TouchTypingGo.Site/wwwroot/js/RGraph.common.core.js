...
(function (win, doc, undefined)
{
    ...
    */
    ...
    RG.Clear = function (ca)
    {
        ...
        */
        if (RG.Registry.Get('chart.tooltip') && obj && obj.get('chart.tooltips.nohideonclear') !== true) {
            RG.HideTooltip(ca);
            //RG.Redraw();
        }
        ...
        */
        function domtext ()
        {
            ...
            */
            ...
            var cacheKey = ma.abs(parseInt(opt.x)) + '_' + ma.abs(parseInt(opt.y)) + '_' + String(opt.text).replace(/[^a-zA-Z0-9]+/g, '_') + obj.canvas.id;
            ...
            // Transform \n to <br />
            opt.text = String(opt.text).replace(/\n/g, '<br />');
